...
dir = '/opt/large-model/qwen/qwen1.5/Qwen1.5/examples/sft/output_qwen1.5_lora'
# dir = "/opt/large-model/llama3/Llama-3-8b-instruct"
...
def traverse_layers(module, depth=0):
    for name, sub_module in module.named_children():
        ...
        print(
            ...
            f"{fixed_params} 个固定参数, {trainable_params} 个可训练参数"
        )
        # 检查是否存在权重矩阵
