...
MODEL="/opt/large-model/qwen/qwen1.5/Qwen1.5-4B-Chat/" # Set the path if you do not want to load from huggingface directly
...
/opt/large-model/qwen/qwen1.5/Qwen1.5/examples/sft/finetune.py \
  ...
  --data_path $DATA \
  --bf16 True \
  --output_dir /opt/large-model/qwen/qwen1.5/Qwen1.5/examples/sft/output_qwen1.5_lora \
  --num_train_epochs 1 \
